		...
		@if(Auth::user()->roles->first()->name == "preReg-officer" )
        	...
        	<div class="menu_section">
				...
				{{-- joe --}}
					...
					<?php
if($_SERVER['REQUEST_URI']!="/rcef_ws2023/pre_reg/view_farmer"){
...
<!--                    @if (Auth::user()->can('role-list'))
							...
							<ul class="nav child_menu">
								...
								<li><a>Document Generation (FAR, IAR, SAR etc.)<span class="fa fa-chevron-down"></span></a>
									...
									<li><a>Generate Blank FAR<span class="fa fa-chevron-down"></span></a>
										<ul>
											<li><a onclick="genBlankFAR('a3');">Municipal FAR</a></li>
 ...
 ?>
            ...
            <?php
            	// if($_SERVER['REQUEST_URI']!="/rcef_ws2023/extension/home"){
            	// 	if($_SERVER['REQUEST_URI']!="/rcef_ws2023/fargeneration/ps"){
		...
		//	dd($_SERVER['REQUEST_URI']);
            	if($_SERVER['REQUEST_URI']!="/rcef_ws2023/paymaya/distribution"){
            		//dd($_SERVER['REQUEST_URI']);
					   	if($_SERVER['REQUEST_URI']!="/rcef_ws2023/paymaya/report/beneficiary/codes"){
						   if($_SERVER['REQUEST_URI']!="/rcef_ws2023/fargeneration/ebinhi"){
							if($_SERVER['REQUEST_URI']!="/rcef_ws2023/cssDashboard"){
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
					...
					@if(Auth::user()->roles->first()->name == "system-encoder")
					@php
						if($_SERVER['REQUEST_URI'] == "/rcef_ws2023/"){
					...
					@else
							...
							{{-- <li><a href="{{route('FarGenerationVd.index')}}">Validated Profiles re-deployment</a></li>  --}}
						 	 ...
						 	 @endif
								...
								@endif
								  ...
								  <li class="sub_menu"><a> Generate Blank FAR<span class="fa fa-chevron-down"></span></a>
								  	<ul class="nav child_menu">
								  		<li><a onclick="genBlankFAR('a3');">Municipal FAR</a></li>
								  		{{-- <li><a onclick="genBlankFAR('ext');">Municipal FAR Extension</a></li> --}}
						...
						<li><a><i class="fa fa-tasks"></i> Distribution Monitoring<span class="fa fa-chevron-down"></span></a>
							<ul class="nav child_menu">
							@if(Auth::user()->roles->first()->name == "seed-inspector" || Auth::user()->username == "J.Baldonado" || Auth::user()->username == "L.Padua" || Auth::user()->username == "R.Millena" || Auth::user()->roles->first()->name == "rcef-coordinator" || Auth::user()->username == "A.Rivera" )
